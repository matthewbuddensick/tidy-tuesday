...
```
    ...
    ##    <dbl> <chr>   <chr>          <dbl> <chr>               
    ##  1   100 rmse    standard   59773.    Preprocessor1_Model1
    ##  2   100 mae     standard   35201.    Preprocessor1_Model1
    ##  3   100 rsq     standard       0.276 Preprocessor1_Model1
    ##  4   250 rmse    standard   59227.    Preprocessor1_Model2
    ##  5   250 mae     standard   34912.    Preprocessor1_Model2
    ##  6   250 rsq     standard       0.288 Preprocessor1_Model2
    ##  7   500 rmse    standard   59409.    Preprocessor1_Model3
    ##  8   500 mae     standard   34985.    Preprocessor1_Model3
    ##  9   500 rsq     standard       0.284 Preprocessor1_Model3
    ## 10  1000 rmse    standard   59453.    Preprocessor1_Model4
    ## 11  1000 mae     standard   35034.    Preprocessor1_Model4
    ## 12  1000 rsq     standard       0.283 Preprocessor1_Model4
    ## 
    ## [[2]]
    ## # A tibble: 12 x 5
    ##    trees .metric .estimator .estimate .config             
    ##    <dbl> <chr>   <chr>          <dbl> <chr>               
    ##  1   100 rmse    standard   67171.    Preprocessor1_Model1
    ##  2   100 mae     standard   35873.    Preprocessor1_Model1
    ##  3   100 rsq     standard       0.250 Preprocessor1_Model1
    ##  4   250 rmse    standard   67114.    Preprocessor1_Model2
    ##  5   250 mae     standard   35833.    Preprocessor1_Model2
    ##  6   250 rsq     standard       0.251 Preprocessor1_Model2
    ##  7   500 rmse    standard   67106.    Preprocessor1_Model3
    ##  8   500 mae     standard   35837.    Preprocessor1_Model3
    ##  9   500 rsq     standard       0.251 Preprocessor1_Model3
    ## 10  1000 rmse    standard   67033.    Preprocessor1_Model4
    ## 11  1000 mae     standard   35793.    Preprocessor1_Model4
    ## 12  1000 rsq     standard       0.252 Preprocessor1_Model4
    ## 
    ## [[3]]
    ## # A tibble: 12 x 5
    ##    trees .metric .estimator .estimate .config             
    ##    <dbl> <chr>   <chr>          <dbl> <chr>               
    ##  1   100 rmse    standard   65239.    Preprocessor1_Model1
    ##  2   100 mae     standard   36417.    Preprocessor1_Model1
    ##  3   100 rsq     standard       0.330 Preprocessor1_Model1
    ##  4   250 rmse    standard   65208.    Preprocessor1_Model2
    ##  5   250 mae     standard   36392.    Preprocessor1_Model2
    ##  6   250 rsq     standard       0.331 Preprocessor1_Model2
    ##  7   500 rmse    standard   65174.    Preprocessor1_Model3
    ##  8   500 mae     standard   36333.    Preprocessor1_Model3
    ##  9   500 rsq     standard       0.332 Preprocessor1_Model3
    ## 10  1000 rmse    standard   65107.    Preprocessor1_Model4
    ## 11  1000 mae     standard   36290.    Preprocessor1_Model4
    ## 12  1000 rsq     standard       0.333 Preprocessor1_Model4
    ## 
    ## [[4]]
    ## # A tibble: 12 x 5
    ##    trees .metric .estimator .estimate .config             
    ##    <dbl> <chr>   <chr>          <dbl> <chr>               
    ##  1   100 rmse    standard   63562.    Preprocessor1_Model1
    ##  2   100 mae     standard   36304.    Preprocessor1_Model1
    ##  3   100 rsq     standard       0.273 Preprocessor1_Model1
    ##  4   250 rmse    standard   63473.    Preprocessor1_Model2
    ##  5   250 mae     standard   36273.    Preprocessor1_Model2
    ##  6   250 rsq     standard       0.274 Preprocessor1_Model2
    ##  7   500 rmse    standard   63452.    Preprocessor1_Model3
    ##  8   500 mae     standard   36205.    Preprocessor1_Model3
    ##  9   500 rsq     standard       0.275 Preprocessor1_Model3
    ## 10  1000 rmse    standard   63483.    Preprocessor1_Model4
    ## 11  1000 mae     standard   36243.    Preprocessor1_Model4
    ## 12  1000 rsq     standard       0.275 Preprocessor1_Model4
    ## 
    ## [[5]]
    ## # A tibble: 12 x 5
    ##    trees .metric .estimator .estimate .config             
    ##    <dbl> <chr>   <chr>          <dbl> <chr>               
    ##  1   100 rmse    standard   62980.    Preprocessor1_Model1
    ##  2   100 mae     standard   35242.    Preprocessor1_Model1
    ##  3   100 rsq     standard       0.302 Preprocessor1_Model1
    ##  4   250 rmse    standard   62958.    Preprocessor1_Model2
    ##  5   250 mae     standard   35152.    Preprocessor1_Model2
    ##  6   250 rsq     standard       0.302 Preprocessor1_Model2
    ##  7   500 rmse    standard   62915.    Preprocessor1_Model3
    ##  8   500 mae     standard   35199.    Preprocessor1_Model3
    ##  9   500 rsq     standard       0.303 Preprocessor1_Model3
    ## 10  1000 rmse    standard   62994.    Preprocessor1_Model4
    ## 11  1000 mae     standard   35139.    Preprocessor1_Model4
    ## 12  1000 rsq     standard       0.302 Preprocessor1_Model4
